...
IyzipayResource.prototype._request = async function (method, cb) {
    ...
    try {
        ...
        debug('Request', util.inspect(options, false, null, true));
        ...
        debug('Response', util.inspect(response.data, false, null, true));
